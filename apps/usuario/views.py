...
class Login(FormView):
    ...
    success_url = reverse_lazy('evaluacionHome')
    ...
    def form_valid(self, form):
        ...
        if not usuario.usuario_activo:
            messages.error(self.request, "El usuario no está activo, debe comunicarse con el administrador.")
...
def logoutUsuario(request):
    logout(request)
    return HttpResponseRedirect('/evaluacion/evaluacionHome/')
